...
map.on('locationerror', function (e) {
  notifySreenReader(e.code == 1 ? 'Please grant loacation permission' : e.message, true); // Handle the error appropriately (e.g., show an alert or a fallback message)
  alert(e.code == 1 ? 'Please grant loacation permission' : e.message); // Handle the error appropriately (e.g., show an alert or a fallback message)
});
